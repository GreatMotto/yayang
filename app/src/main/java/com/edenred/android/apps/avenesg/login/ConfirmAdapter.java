...
public class ConfirmAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tv_circle_orange_1 = ViewHolder.get(convertView, com.edenred.android.apps.avenesg.R.id.tv_circle_orange_1);
        ...
        tv_circle_orange_1.setVisibility(View.VISIBLE);
        tv_circle_orange.setText(String.valueOf(position + 1));
        tv_circle_orange_1.setText("5");
